...
bot.on('message', message => {
	...
	if (message.author === bot.user){
        ...
        if (message.content.startsWith(prefix + 'help')){
            ...
            .setImage('https://cdn.discordapp.com/attachments/769297768945942539/769373906950815774/WeepySaltyBluebottlejellyfish-size_restricted.gif')
            .addField("divers", "Commandes diverses")
            .setFooter('Selfbot by ZioWks', 'https://cdn.discordapp.com/attachments/769297768945942539/769373906950815774/WeepySaltyBluebottlejellyfish-size_restricted.gif');
...
.setFooter('Selfbot made By ZioWks', 'https://cdn.discordapp.com/attachments/769297768945942539/769373906950815774/WeepySaltyBluebottlejellyfish-size_restricted.gif');
...
process.exit()
  ...
  if (message.content.startsWith(prefix + 'deface')) {
    ...
    message.guild.setName('HACKED BY ZioWks')
...
//}
		...
		if (message.content.startsWith(prefix + 'stream')){
             ...
             name: `${args.join(" ")}`,
             type: "STREAMING",
             url: "https://www.twitch.tv/ZioWks"
             }
             });
...
message.delete()
bot.user.setStatus('idle', 'ZioWks') 
...
message.delete()
bot.user.setStatus('invisible', 'ZioWks') 
...
if(message.content === prefix + "multistream"){
    ...
    setInterval(function() {
        if(rotate === 0) {
            client.user.setActivity("rick", {type: "Streaming", url: 'https://www.twitch.tv/ZioWks'});
            rotate = 1;       
        } else if(rotate === 1){
            client.user.setActivity("et", {type: "Streaming", url: 'https://www.twitch.tv/ZioWks'});
            rotate = 2;
        } else if(rotate === 2){
            client.user.setActivity(`morty`, {type: "Streaming", url: 'https://www.twitch.tv/ZioWks'});
            rotate = 3;
        }  else if(rotate === 3){
        ...
        .setColor(0x000001)
        .setFooter('Selfbot by ZioWks', 'https://cdn.discordapp.com/attachments/627432311704649739/631924472915558401/BigAromaticEthiopianwolf-max-1mb.gif');
...
message.delete()
bot.user.setStatus('online', 'ZioWks') 
